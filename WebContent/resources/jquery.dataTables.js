				...
				$(nScrollBody).scroll( function() {
					...
					if ( !oSettings.bDrawing )
					{
							...
							$(oSettings.nTable).height() - oSettings.oScroll.iLoadGap )
						{
							...
							{
								//alert(oSettings.fnRecordsDisplay() + " " + oSettings.fnDisplayEnd());
								$.getJSON('../ajax/jsonSource', 
										{
											fnRecordsDisplay: oSettings.fnRecordsDisplay()
										},
										function(data){
											alert(data);
											_that.fnAddData(data.aaData, false); //Binu
										});
